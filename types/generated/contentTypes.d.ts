...
export interface ApiAnimeAnime extends Schema.CollectionType {
	...
	attributes: {
		...
		createdAt: Attribute.DateTime
		updatedAt: Attribute.DateTime
		createdBy: Attribute.Relation<"api::anime.anime", "oneToOne", "admin::user"> &
			Attribute.Private
		updatedBy: Attribute.Relation<"api::anime.anime", "oneToOne", "admin::user"> &
			Attribute.Private
	}
}
...
export interface ApiBookBook extends Schema.CollectionType {
	...
	attributes: {
		...
		was_deleted: Attribute.Boolean & Attribute.Required & Attribute.DefaultTo<false>
		book_pages: Attribute.Relation<"api::book.book", "oneToMany", "api::book-page.book-page">
		createdAt: Attribute.DateTime
		updatedAt: Attribute.DateTime
...
export interface ApiBookPageBookPage extends Schema.CollectionType {
	...
	attributes: {
		...
		background_scene: Attribute.String & Attribute.Required & Attribute.DefaultTo<"default">
		was_deleted: Attribute.Boolean & Attribute.Required & Attribute.DefaultTo<false>
		createdAt: Attribute.DateTime
		updatedAt: Attribute.DateTime
		publishedAt: Attribute.DateTime
		createdBy: Attribute.Relation<"api::book-page.book-page", "oneToOne", "admin::user"> &
			Attribute.Private
		updatedBy: Attribute.Relation<"api::book-page.book-page", "oneToOne", "admin::user"> &
			Attribute.Private
	}
}
...
export interface ApiBubbleBubble extends Schema.CollectionType {
	...
	attributes: {
		...
		createdBy: Attribute.Relation<"api::bubble.bubble", "oneToOne", "admin::user"> &
			Attribute.Private
		updatedBy: Attribute.Relation<"api::bubble.bubble", "oneToOne", "admin::user"> &
			Attribute.Private
	}
}
...
export interface ApiFranchiseFranchise extends Schema.CollectionType {
	...
	attributes: {
		...
		createdAt: Attribute.DateTime
		updatedAt: Attribute.DateTime
		createdBy: Attribute.Relation<"api::franchise.franchise", "oneToOne", "admin::user"> &
			Attribute.Private
		updatedBy: Attribute.Relation<"api::franchise.franchise", "oneToOne", "admin::user"> &
			Attribute.Private
	}
}
...
export interface ApiJurisdictionJurisdiction extends Schema.CollectionType {
	...
	attributes: {
		...
		createdAt: Attribute.DateTime
		updatedAt: Attribute.DateTime
		createdBy: Attribute.Relation<"api::jurisdiction.jurisdiction", "oneToOne", "admin::user"> &
			Attribute.Private
		updatedBy: Attribute.Relation<"api::jurisdiction.jurisdiction", "oneToOne", "admin::user"> &
			Attribute.Private
	}
}
...
export interface ApiTimeLineTimeLine extends Schema.CollectionType {
	...
	attributes: {
		...
		books: Attribute.Relation<"api::time-line.time-line", "oneToMany", "api::book.book">
		events: Attribute.Relation<"api::time-line.time-line", "oneToMany", "api::event.event">
		createdAt: Attribute.DateTime
		updatedAt: Attribute.DateTime
		publishedAt: Attribute.DateTime
		createdBy: Attribute.Relation<"api::time-line.time-line", "oneToOne", "admin::user"> &
			Attribute.Private
		updatedBy: Attribute.Relation<"api::time-line.time-line", "oneToOne", "admin::user"> &
			Attribute.Private
	}
}
...
export interface ApiWorldWorld extends Schema.CollectionType {
	...
	attributes: {
		...
		time_lines: Attribute.Relation<"api::world.world", "oneToMany", "api::time-line.time-line">
		createdAt: Attribute.DateTime
		updatedAt: Attribute.DateTime
		publishedAt: Attribute.DateTime
		createdBy: Attribute.Relation<"api::world.world", "oneToOne", "admin::user"> &
			Attribute.Private
		updatedBy: Attribute.Relation<"api::world.world", "oneToOne", "admin::user"> &
			Attribute.Private
	}
}
